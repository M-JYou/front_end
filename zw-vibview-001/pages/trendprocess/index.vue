<template>
	<view class="pages">
		...
		<view>
			<u-picker class="upickerboxx" mode="time" v-model="show" :params="params" @confirm="confirm"></u-picker>
		</view>
	</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			//             uni.redirectTo ({url:'/pages/projectDevie/index'})  
