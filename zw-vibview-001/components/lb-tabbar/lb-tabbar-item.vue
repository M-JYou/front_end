...
.lb-tabbar-item{
	...
	// background: linear-gradient(286deg, #CDE4FF 0%, rgba(255, 255, 255, 0) 100%);
	position: relative;
}
// .lb-tabbar-item:before{
// 	content: '';
// 	position: absolute;
// 	top: -10rpx;
// 	width: 100%;
// 	height: 10rpx;
// }
// .lb-tabbar-item:first-child:before{
// 	border-radius: 20rpx 0 0 0;
// }
.lb-tabbar-item.raisede-item{
	/* #ifndef MP-WEIXIN */
	width: 26%;
	margin: 0 3%;
	/* #endif */
