 ...
 * @method static Query where(mixed $field, string $op = null, mixed $condition = null)static 查询条件
 * @method static Query join(mixed $join, mixed $condition = null, string $type = 'INNER')static JOIN查询
 * @method static Query union(mixed $union, boolean $all = false)static UNION查询
 * @method static Query limit(mixed $offset, integer $length = null)static 查询LIMIT
 * @method static Query order(mixed $field, string $order = null)static 查询ORDER
 * @method static Query cache(mixed $key = null , integer $expire = null)static 设置查询缓存
 * @method static mixed value(string $field)static 获取某个字段的值
 * @method static array column(string $field, string $key = '')static 获取某个列的值
 * @method static Query view(mixed $join, mixed $field = null, mixed $on = null, string $type = 'INNER')static 视图查询
 ...
 * @method static Paginator paginate(integer $listRows = 15, mixed $simple = null, array $config = [])static 分页查询
 ...
 * @method static string quote(string $str)static SQL指令安全过滤
 * @method static string getLastInsID($sequence = null)static 获取最近插入的ID
 */
class Db
{
    /**
