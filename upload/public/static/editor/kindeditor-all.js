...
K.options = {
    ...
    'video', 'flash', 'media', 'baidumap', 'emoticons', '|', 'insertfile', 'table', 'hr', 'pagebreak',
...
function createEdit(dom,opt) {
  return KindEditor.create(dom, Object.assign({
    width: "100%",
    uploadJson: qscms.apiUrl + "/member/upload/index",
    filePostName: "file",
    extraFileUploadParams: {
      "user-token": Cookies.getJSON("qscms_visitor")?.token,
    },
    formatUploadUrl: false,
    fillDescAfterUploadImage: true,
    filterMode: false,
    afterCreate() {
      KindEditor.query(`div.ke-hr`)?.remove();
    },
  },opt));
}
