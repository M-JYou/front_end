    ...
    public function callPay($option)
    {
        ...
        switch ($option['platform']) {
            ...
            case 'wechat':
                ...
                break;
            case 'miniprogram':
                WxPayConfig::$appid = $this->config['wechat_miniprogram_appid'];
                WxPayConfig::$appsecret = $this->config['wechat_miniprogram_appsecret'];
                $return = $this->_pay_from_miniprogram($option);
                break;
            case 'app':
