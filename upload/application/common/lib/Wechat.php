      ...
      if (!empty($sub_menu)) {
        ...
        foreach ($sub_menu as $sub_key => $sub_value) {
          ...
          if ($sub_value['type'] == "click") {
            ...
            $arr[$key]['sub_button'][$sub_key]['appid'] = config('global_config.wechat_miniprogram_appid');
            $arr[$key]['sub_button'][$sub_key]['pagepath'] = $sub_value['pagepath'];
            $arr[$key]['sub_button'][$sub_key]['url'] = 'http://mp.weixin.qq.com';
          } else {
        ...
        if ($value['type'] == "click") {
          ...
          $arr[$key]['appid'] = config('global_config.wechat_miniprogram_appid');
          $arr[$key]['pagepath'] = $value['pagepath'];
          $arr[$key]['url'] = 'http://mp.weixin.qq.com';
        } else {
