...
class Games extends BaseValidate {
  protected $rule =   [
    ...
    'games'           => '>=:0',        // INT(10) NOT NULL DEFAULT 0 COMMENT '隶属id;评论需要设置此值为目标id',
    'name'            => 'max:32',      // CHAR(32) NOT NULL COMMENT '名称',
    'cover'           => 'max:255',     // CHAR(255) NOT NULL COMMENT '封面',
    'link'            => 'max:255',     // CHAR(255) NOT NULL COMMENT '名称',
