...
use app\common\model\AskAnswer as Model;

class AskAnswer extends \app\v1_0\controller\common\Base {
  ...
  public function read($_params = null) {
    ...
    foreach ($ret as $key => $v) {
      $v->comments = (new \app\v1_0\controller\home\AskAnswerComment)->read(['answer' => $v->id]);
    }
    if ($_params) {
      return $ret;
    } else {
