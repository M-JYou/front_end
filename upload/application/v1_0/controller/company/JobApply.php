...
class JobApply extends \app\v1_0\controller\common\Base {
    ...
    public function index() {
        ...
        $list = model('JobApply')
            ...
            ->field('a.id,b.is_live,a.comid,a.companyname,a.jobid,a.jobname,a.resume_id,a.fullname,a.note,a.addtime,a.is_look,a.handle_status,a.source,a.platform,b.display_name,b.high_quality,b.birthday,b.sex,b.education,b.enter_job_time,b.photo_img,b.current,b.remark,b.audit')
            ->where($where)
            ->where('b.id', 'not null')
            ->order('a.id desc')
