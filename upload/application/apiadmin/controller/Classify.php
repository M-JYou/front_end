...
class Classify extends \app\common\controller\Backend {
    ...
    private function freelanceResumeAudit($params = []) {
        $list = model('FreelanceResume')->map_audit;
        $return = [];
        foreach ($list as $key => $value) {
            $arr['id'] = $key;
            $arr['name'] = $value;
    ...
    private function freelanceSubjectAudit($params = []) {
        $list = model('FreelanceSubject')->map_audit;
        $return = [];
        foreach ($list as $key => $value) {
            $arr['id'] = $key;
            $arr['name'] = $value;
    ...
    private function cityInfoArticleAudit($params = []) {
        $list = model('CityinfoArticle')->map_audit;
        $return = [];
        foreach ($list as $key => $value) {
            $arr['id'] = $key;
            $arr['name'] = $value;
    ...
    private function cityInfoPhoneBookType() {
        $m = new CityinfoPhoneBookType();
        return $m->select();
    }

    private function cityInfoPhoneBookAudit() {
