<template>
  <view class="hrListItem">
    <view class="wrapbox" v-for="(item,i) in subcontractData" :key="item.id">
  ...
  export default {
    data() {
      return {
        ...
        subcontractData: [],
        URL: '/pages/work/manage/manageSubcontract/indexDetails'
      }
    },

    methods: {
      getData() {
        getManageSubcontract(this.formData).then(res => {
